...
pub use wgpu::{
    ...
    StorageTextureAccess as RawStorageTextureAccess, StoreOp, Surface as WgpuSurface,
    Texture as WgpuTexture, TextureAspect, TextureDescriptor as RawTextureDescriptor,
