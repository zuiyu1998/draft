...
use crate::frame_graph::{
    AnyTransientResource, ArcAnyTransientResource, Handle, ResourceNode, ResourceRef,
...
pub struct ResourceTable {
    resources: HashMap<Handle<ResourceNode>, AnyTransientResource>,
}
...
impl ResourceTable {
    ...
    pub fn request_resource<T: TransientResourceCreator>(
        &mut self,
