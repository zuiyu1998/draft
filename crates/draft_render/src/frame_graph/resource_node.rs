...
use crate::frame_graph::{Handle, PassNode, TransientResource, VirtualResource};
...
pub struct ResourceNode {
    pub index: Handle<ResourceNode>,
    pub name: String,
    pub first_use_pass: Option<Handle<PassNode>>,
    pub last_user_pass: Option<Handle<PassNode>>,
    version: u32,
...
impl ResourceNode {
    pub fn new(name: &str, index: Handle<ResourceNode>, resource: VirtualResource) -> Self {
        ResourceNode {
            name: name.to_string(),
            index,
            version: 0,
...
impl ResourceNode {
    ...
    pub fn update_lifetime(&mut self, handle: Handle<PassNode>) {
