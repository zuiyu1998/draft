...
use crate::frame_graph::{Index, PassNode, TransientResource, VirtualResource};
...
pub struct ResourceNode {
    pub index: Index<ResourceNode>,
    pub name: String,
    pub first_use_pass: Option<Index<PassNode>>,
    pub last_user_pass: Option<Index<PassNode>>,
    version: u32,
...
impl ResourceNode {
    pub fn new(name: &str, index: Index<ResourceNode>, resource: VirtualResource) -> Self {
        ResourceNode {
            name: name.to_string(),
            index,
            version: 0,
...
impl ResourceNode {
    ...
    pub fn update_lifetime(&mut self, handle: Index<PassNode>) {
